...
import { Badge, Box, SimpleGrid, Text, Flex, Button } from "@chakra-ui/core";
...
function LaunchPadItem({ launchPad }) {
	...
	const isFavourite = favourites.find((fav) => fav.name === launchPad.name);
